                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered text-center" id="dataTable" width="100%" cellspacing="0">
                                    <thead>
                                        ...
                                        <?php $no = 1;
                                        foreach ($peminjaman as $pnjmn) : ?>
                                    <tbody>
                                        <tr>
                                            <td><?= $no++; ?></td>
                                            <td><?= $pnjmn['kd_anggota']; ?></td>
                                            <td><?= $pnjmn['kd_buku']; ?></td>
                                            <td><?= $pnjmn['jumlah_pinjam']; ?></td>
                                            <td><?= $pnjmn['tanggal_pinjam']; ?></td>
                                            <td>
                                                <a href="<?= base_url() ?>user/edit_data_peminjam/<?= $pnjmn['kd_peminjaman']; ?>" class="badge badge-primary">Edit</a>
                                                <a href="<?= base_url() ?>user/hapus_data_peminjam/<?= $pnjmn['kd_peminjaman']; ?>" class="badge badge-danger">Delete</a>
                                            </td>
                                        </tr>
                                        </thead>
            ...
            <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <?= form_open_multipart('user/proses_tambah_data_peminjam'); ?>
                        <div class="modal-body">
                            <div class="form-group">
                                <label>Kode Peminjam</label>
                                <input type="number" name="kd_peminjaman" class=" form-control"></input>
                                <div class="form-group">
                                    <label>Kode Anggota</label>
                                    <select name="kd_anggota" class="form-control">
                                        <?php foreach ($data_anggota as $a) : ?>
                                            <option value="<?= $a->kd_anggota ?>"><?= $a->kd_anggota ?></option>
                                        <?php endforeach; ?>
                                    </select>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="jumlah_pinjam" class=" form-control" required=""></input>
                                    </div>
                                    <div class="form-group">
                                        <label>Tanggal Pinjam</label>
                                        <input type="date" name="tanggal_pinjam" class=" form-control" required=""></input>
                                    </div>
                                </div>
