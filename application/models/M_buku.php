...
class M_buku extends CI_Model
{
    ...
    {
        $query = $this->db->query("SELECT * FROM pengarang ORDER BY kd_pengarang ASC");
        return $query->result();
    }
    public function get_combo_penerbit()
    {
        $query = $this->db->query("SELECT * FROM penerbit ORDER BY kd_penerbit ASC");
        return $query->result();
    }
    public function get_combo_jenisbuku()
    {
        $query = $this->db->query("SELECT * FROM jenis_buku ORDER BY kd_jenis_buku ASC");
        return $query->result();
    }
    public function get_combo_anggota()
    {
        $query = $this->db->query("SELECT * FROM anggota ORDER BY kd_anggota ASC");
        return $query->result();
    }
    public function get_combo_buku()
    {
        $query = $this->db->query("SELECT * FROM buku ORDER BY kd_buku ASC");
        return $query->result();
    }
    public function get_count()
    {
        $sql = "SELECT count(judul) as judul FROM buku";
        $result = $this->db->query($sql);
        return $result->row()->judul;
    }
    public function get_count_peminjam()
    {
        $sql = "SELECT count(kd_peminjaman) as kd_peminjaman FROM peminjaman";
        $result = $this->db->query($sql);
        return $result->row()->kd_peminjaman;
    }
    public function get_count_jenis_buku()
    {
        $sql = "SELECT count(kd_jenis_buku) as kd_jenis_buku FROM jenis_buku";
        $result = $this->db->query($sql);
        return $result->row()->kd_jenis_buku;
    }
    public function get_count_anggota()
    {
        $sql = "SELECT count(kd_anggota) as kd_anggota FROM anggota";
        $result = $this->db->query($sql);
        return $result->row()->kd_anggota;
    }
    public function get_count_penerbit()
    {
        $sql = "SELECT count(kd_penerbit) as kd_penerbit FROM penerbit";
        $result = $this->db->query($sql);
        return $result->row()->kd_penerbit;
    }
    public function get_count_pengarang()
    {
        $sql = "SELECT count(kd_pengarang) as kd_pengarang FROM pengarang";
        $result = $this->db->query($sql);
        return $result->row()->kd_pengarang;
    }
