...
class User extends CI_Controller
{
    ...
    {
        $this->M_buku->hapus_data_peminjam($kd_peminjaman);
        redirect('user/data_peminjaman');
    }

    public function hapus_data_buku($kd_buku)
    {
        $this->M_buku->hapus_data_buku($kd_buku);
    ...
    public function index()
    {
        ...
        $data['user'] = $this->db->get_where('users', ['email' => $this->session->userdata('email')])->row_array();
        $data['count'] = $this->M_buku->get_count();
        $data['count_peminjam'] = $this->M_buku->get_count_peminjam();
        $data['count_jenis_buku'] = $this->M_buku->get_count_jenis_buku();
        $data['count_anggota'] = $this->M_buku->get_count_anggota();
        $data['count_penerbit'] = $this->M_buku->get_count_penerbit();
        $data['count_pengarang'] = $this->M_buku->get_count_pengarang();
    ...
    public function data_peminjaman()
    {
        ...
        $data['user'] = $this->db->get_where('users', ['email' => $this->session->userdata('email')])->row_array();
        $data['data_anggota'] = $this->M_buku->get_combo_anggota();
        $data['data_buku'] = $this->M_buku->get_combo_buku();
    ...
    public function databuku()
    {
        ...
        $data['user'] = $this->db->get_where('users', ['email' => $this->session->userdata('email')])->row_array();
        $data['data_pengarang'] = $this->M_buku->get_combo();
        $data['data_penerbit'] = $this->M_buku->get_combo_penerbit();
        $data['data_jenisbuku'] = $this->M_buku->get_combo_jenisbuku();
